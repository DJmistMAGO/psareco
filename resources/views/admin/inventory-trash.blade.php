...
@section('content')
		...
		<main class="w-full min-w-0 p-4 sm:p-6 lg:p-8">
				...
				<x-page-header eyebrow="PSARECO Inventory" title="Deleted Products"
						description="View and restore products that have been removed from your inventory." icon="fa-solid fa-trash-can">
						<x-slot:actions>
																...
																<tr class="hover:bg-slate-50/70 transition-colors">
																		...
																		<td class="px-5 py-4">
																				...
																				<div class="flex items-center justify-end gap-2">
																						...
																						{{-- Permanent Delete --}}
																						<x-confirm-modal title="Permanently Delete Product" :message="'Permanently delete ' . $item->name . '? This action cannot be undone.'"
																								confirmText="Delete Permanently" confirmClass="bg-red-600 hover:bg-red-700 text-white"
																								icon="triangle-exclamation" :action="route('inventory.forceDeleteProduct', $item->id)" method="DELETE">
												...
												<div class="p-4">
														...
														<div class="flex items-start justify-between gap-3">
																...
																<div class="flex items-center gap-3 min-w-0">
																		...
																		@if ($item->type === 'Fertilizer')
																				<div
																						class="w-9 h-9 shrink-0 rounded-lg bg-emerald-100 text-emerald-600 flex items-center justify-center">
