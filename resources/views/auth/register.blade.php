...
@section('content')
    <div class="min-h-screen bg-[#d2e8d9] flex items-center justify-center p-0 sm:p-4 lg:p-6 overflow-hidden">
        <div class="relative w-full max-w-6xl min-h-screen sm:min-h-0 lg:min-h-[680px] bg-white/80 backdrop-blur-sm lg:rounded-3xl shadow-2xl border border-white/70 overflow-hidden flex flex-col lg:flex-row">
                ...
                <div class="relative z-10 w-full p-12 flex flex-col justify-between">
                    ...
                    <div class="my-auto max-w-lg pt-8">
                        ...
                        <h2 class="text-4xl xl:text-5xl font-bold tracking-tight leading-tight">
                            Join our community.
                            <span class="block text-emerald-200 mt-1">Grow together.</span>
                        </h2>
                        ...
                        <div class="mt-6 grid grid-cols-2 gap-3 max-w-md">
                            <div class="flex items-center space-x-3 bg-white/10 border border-white/10 rounded-xl px-4 py-3 backdrop-blur-sm">
                                <div class="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center shrink-0">
                                    <i class="fas fa-tractor text-emerald-200 text-sm"></i>
                                </div>
                                <div>
                            ...
                            <div class="flex items-center space-x-3 bg-white/10 border border-white/10 rounded-xl px-4 py-3 backdrop-blur-sm">
                                <div class="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center shrink-0">
                                    <i class="fas fa-boxes-stacked text-emerald-200 text-sm"></i>
                                </div>
                                <div>
            ...
            <div class="relative w-full lg:w-[45%] min-h-screen sm:min-h-0 lg:min-h-full flex items-center justify-center bg-white overflow-hidden py-8 px-4 sm:px-8">
                ...
                <div class="absolute -right-20 -bottom-28 w-[420px] h-[420px] sm:w-[500px] sm:h-[500px] opacity-[0.06] pointer-events-none transform -rotate-12 select-none z-0 lg:hidden">
                ...
                <div class="relative z-10 w-full max-w-md my-auto">
                    ...
                    <div class="text-center mb-6">
                        <a href="{{ route('home') }}" class="inline-block transition-transform hover:scale-105 mb-3">
                            <img src="{{ asset('assets/images/PSARECO_logo.png') }}" alt="PSARECO Logo" class="w-20 sm:w-20 h-auto mx-auto drop-shadow-sm">
                        </a>

                        <h1 class="text-2xl font-bold tracking-tight text-[#2c7a56]">
                            Create Account
                        </h1>
                    ...
                    {{-- <div class="flex items-center justify-center mb-6">
                        <div class="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-emerald-50 border border-emerald-100">
                            <span class="relative flex h-3.5 w-3.5 items-center justify-center text-emerald-600">
                                <i class="fas fa-shield-halved text-xs relative"></i>
                            </span>
                    ...
                    <form method="POST" action="{{ route('register') }}"
                        ...
                        <div class="relative">
                            <input type="text" name="name" id="name" value="{{ old('name') }}" required autocomplete="name" placeholder=" " class="peer w-full px-4 pt-5 pb-2 text-sm text-slate-800 bg-slate-50 border
                                @error('name') border-red-500 focus:ring-red-500 @else border-slate-200 focus:ring-[#3d8b68] focus:border-[#3d8b68] @enderror rounded-xl focus:outline-none focus:ring-2 focus:bg-white transition-all">
                        ...
                        <div class="space-y-1">
                            ...
                            <div x-show="password.length > 0" class="mt-1.5 px-1 space-y-1" x-cloak>
                                ...
                                <div class="flex items-center justify-between text-[10px]">
                                    ...
                                    <span class="font-semibold" :class="strength.color.split(' ')[1]" x-text="strength.text"></span>
                                </div>
                            </div>
                        ...
                        <div class="relative flex items-center">
                            ...
                            <label for="confirmPassword" class="absolute left-4 top-2 text-[11px] font-medium text-slate-400 transition-all peer-placeholder-shown:text-xs peer-placeholder-shown:top-3.5 peer-placeholder-shown:text-slate-400 peer-focus:top-1.5 peer-focus:text-[10px] peer-focus:text-[#2c7a56] flex items-center space-x-1.5 pointer-events-none">
                                <i class="fas fa-shield-check text-slate-400 peer-focus:text-[#2c7a56]"></i>
                                <span>Confirm Password</span>
                            </label>

                            <button type="button" @click="showConfirmPassword = !showConfirmPassword" class="absolute right-3 text-slate-400 hover:text-[#2c7a56] p-1.5 rounded-lg transition-colors focus:outline-none">
                    ...
                    <div class="relative my-6">
                        ...
                        <div class="relative flex justify-center">
                            <span class="px-3 bg-white text-[9px] text-slate-300 uppercase tracking-widest text-center">
                                Polot Somagongsong Agrarian Reform Cooperative
                            </span>
                        </div>
                    </div>
