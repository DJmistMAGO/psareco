...
<div class="min-h-screen bg-[#d2e8d9] flex items-center justify-center p-0 sm:p-4 lg:p-6 overflow-hidden">
    ...
    <div class="relative w-full max-w-6xl min-h-screen sm:min-h-0 lg:min-h-[680px] bg-white/80 backdrop-blur-sm lg:rounded-3xl shadow-2xl border border-white/70 overflow-hidden flex flex-col lg:flex-row">
        ...
        <div class="relative hidden lg:flex lg:w-[55%] overflow-hidden bg-gradient-to-br from-[#2c7a56] via-[#3d8b68] to-[#286347] text-white">
            ...
            <div class="absolute -right-20 -bottom-28 w-[420px] h-[420px] opacity-10 pointer-events-none transform -rotate-12 select-none z-0">
                <img
                    ...
                    alt=""
                    class="w-full h-full object-contain filter brightness-200"
                >
            </div>
            ...
            <div class="relative z-10 w-full p-12 flex flex-col">
                ...
                <div class="mt-16 max-w-lg">
                    ...
                    <h2 class="text-4xl xl:text-5xl font-bold tracking-tight leading-tight">
                        Manage your farm.
                        <span class="text-emerald-200">Smarter.</span>
                    </h2>

                    <p class="mt-5 text-sm leading-6 text-white/70 max-w-md">
                        A centralized platform for managing agricultural machinery,
                        monitoring farm inventory, and organizing day-to-day farm operations.
                    </p>
                ...
                <div class="mt-auto flex items-center justify-between text-[10px] text-white/50">
        ...
        <div class="relative w-full lg:w-[45%] min-h-screen sm:min-h-0 lg:min-h-full flex items-center justify-center bg-white overflow-hidden">
            ...
            <div class="relative z-10 w-full max-w-md p-6 sm:p-8 lg:p-10 my-auto">
                    ...
                    <a href="{{ route('home') }}" class="inline-block transition-transform hover:scale-105">
                        <div class="relative">
                            <img
                                src="{{ asset('assets/images/PSARECO_logo.png') }}"
                                alt="PSARECO Logo"
                                class="w-20 h-auto mx-auto drop-shadow-sm"
                            >
                        </div>
                    </a>

                    <h1 class="mt-3 mb-2 text-3xl font-bold tracking-tight text-[#2c7a56]"> PSARECO </h1>

                    <p class="text-xs font-bold text-slate-600 mt-1 uppercase tracking-wide"> Farm Resource Management System </p>
                ...
                <div class="flex items-center justify-center mb-6">
                    ...
                    <div class="inline-flex items-center space-x-2 px-3 py-1.5 rounded-full bg-emerald-50 border border-emerald-100">
                        ...
                        <span class="text-[10px] font-semibold text-emerald-700">
                            Secure Farm Resource Management Portal
                        </span>
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-4">
                    ...
                    <div class="relative">
                        ...
                        <input
                            ...
                            autocomplete="off"
                            placeholder=" "
                            class="peer w-full px-4 pt-5 pb-2 text-sm text-slate-800 bg-slate-50 border
                            @error('email')
                        ...
                        <label
                            for="email"
                            class="absolute left-4 top-2 text-[11px] font-medium text-slate-400
                            transition-all peer-placeholder-shown:text-xs
                            peer-placeholder-shown:top-3.5
                            peer-placeholder-shown:text-slate-400
                            peer-focus:top-1.5 peer-focus:text-[10px]
                            peer-focus:text-[#2c7a56]
                            flex items-center space-x-1.5 pointer-events-none"
                        >
                    ...
                    <div x-data="{ showPassword: false }" class="relative">
                        ...
                        <div class="relative flex items-center">
                            ...
                            <input
                                ...
                                placeholder=" "
                                class="peer w-full pl-4 pr-12 pt-5 pb-2 text-sm text-slate-800 bg-slate-50 border
                                @error('password')
                                    border-red-500 focus:ring-red-500
                                @else
                                    border-slate-200 focus:ring-[#3d8b68] focus:border-[#3d8b68]
                    ...
                    <button
                        type="submit"
                        class="w-full mt-2 bg-[#3d8b68] hover:bg-[#327356] active:bg-[#276447]
                ...
                <div class="text-center mt-6">
                    ...
                    <p class="text-xs text-slate-500">
                        ...
                        <a
                            href="{{ route('register') }}"
                            class="text-[#2c7a56] font-bold hover:underline"
                        >
                            Register here
                        </a>
