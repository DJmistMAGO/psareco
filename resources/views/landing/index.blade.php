...
>
    ...
    <div
        x-show="open"
        x-transition
        class="mx-4 rounded-2xl bg-white p-5 shadow-xl lg:hidden"
    >
        ...
        <div class="flex flex-col gap-4">
            ...
            <a href="#machinery" class="font-medium">
                Machinery
            </a>

            <a href="#inventory" class="font-medium">
                Inventory
            </a>

            <a href="#how-it-works" class="font-medium">
                How It Works
            </a>
            ...
            <a
                href="{{-- route('login')--}}"
                class="rounded-lg border border-farm-700 px-5 py-3 text-center font-semibold text-farm-700"
            >
                Login
            </a>
            ...
            <a
                href="{{-- route('register')--}}"
                class="rounded-lg bg-farm-700 px-5 py-3 text-center font-semibold text-white"
            >
                Get Started
            </a>
