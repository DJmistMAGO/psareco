    ...
    <section id="home" class="relative min-h-[700px] overflow-hidden" >
        ...
        <div class="relative mx-auto flex min-h-[700px] max-w-7xl items-center px-6 pt-24 lg:px-8">
            ...
            <div class="max-w-xl">
                ...
                {{-- Label --}}
                <div class="mb-6 inline-flex items-center gap-2 rounded-full bg-farm-100 px-4 py-2 text-xs font-bold uppercase tracking-wider text-farm-800" >
                ...
                <div class="mt-9 flex flex-col gap-4 sm:flex-row">
                    ...
                    <a href="#machinery" class="inline-flex items-center justify-center gap-2 rounded-xl bg-farm-700 px-7 py-4 font-bold text-white shadow-xl shadow-farm-700/20 transition hover:-translate-y-0.5 hover:bg-farm-800" >
                    ...
                    <a href="#inventory" class="inline-flex items-center justify-center gap-2 rounded-xl border-2 border-farm-700 bg-white/90 px-7 py-4 font-bold text-farm-800 transition hover:bg-farm-50" >
                        <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path
                                stroke-linecap="round"
                                stroke-linejoin="round"
